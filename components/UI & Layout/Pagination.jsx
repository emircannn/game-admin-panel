      ...
      if (i === 1 || i === totalPages || isWithinSiblingRange) {
        pageNumbers.push(
          <li
            ...
            key={i}
            className={`${i === currentPage ? 'bg-secondary hover:bg-graident-dark' : ' bg-graident-dark hover:bg-secondary'} rounded-full flex items-center 
  ...
  return (
    <div className="text-white flex items-center">
      <ul className='flex items-center gap-[10px]'>
        <li 
        className='flex items-center justify-center cursor-pointer bg-graident-dark hover:bg-secondary duration-300 rounded-full '
        style={{width: size, height: size, fontSize: textSize}}
